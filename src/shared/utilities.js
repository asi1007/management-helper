...
function getEnvConfig() {
  ...
  return {
    ...
    INSPECTION_MASTER_SHEET_ID: getEnv('INSPECTION_MASTER_SHEET_ID', '1Dvz3cS9DRGx4woEY0NNypgLPKxLZ55a4j8778YlCFls'),
    INSPECTION_MASTER_SHEET_GID: getEnv('INSPECTION_MASTER_SHEET_GID', '414729247'),
    INSPECTION_TEMPLATE_SHEET_ID: getEnv('INSPECTION_TEMPLATE_SHEET_ID', '1yG4c-wGu2ImUkkPpW1IE1d3_57yjkUGUaLi8APCakMM'),
    INSPECTION_TEMPLATE_SHEET_GID: getEnv('INSPECTION_TEMPLATE_SHEET_GID', '25016586'),
